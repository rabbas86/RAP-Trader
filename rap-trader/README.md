...
Phase 13 adds the deterministic offline [Chairman](docs/CHAIRMAN.md), the research-governance authority above the Investment Committee and Risk Officer. Chairman approval is never execution approval; risk rejection is absolute; all outputs remain research-only, unsuitable for live trading, and not decision-ready.
