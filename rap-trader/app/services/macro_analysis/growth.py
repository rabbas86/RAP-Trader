"""Deterministic economic-growth analysis service.

Classifies GDP (and GDP-trend) series into a ``GrowthTrend`` and reports
whether growth is accelerating, decelerating, stable, or negative.
"""
...
from app.services.macro_analysis.domain import GROWTH_CATEGORY
from app.services.macro_analysis.observations import MacroObservation
from app.services.macro_analysis.trends import _map_growth


class GrowthAnalysisService(MacroAnalysisService):
