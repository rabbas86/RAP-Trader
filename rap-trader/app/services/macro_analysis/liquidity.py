"""Deterministic liquidity analysis service.

Classifies the money-supply series into a ``LiquidityTrend``
...
from app.services.macro_analysis.domain import LIQUIDITY_CATEGORY
from app.services.macro_analysis.observations import MacroObservation
from app.services.macro_analysis.trends import _map_liquidity


class LiquidityAnalysisService(MacroAnalysisService):
