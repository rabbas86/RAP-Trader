...
2. Phase 2 - validated market-data ingestion.
3. Phase 3 - offline Kronos integration and evaluation.
4. Phase 4 - reproducible backtesting with costs and bias controls.
